...
const tableHeading = ["Branch Name", "Branch Code","Email", "Phone Number", "Address", "Action"];
            ...
            {getRes?.data?.length > 0 ?
              getRes?.data?.map(elem => (
                <StyledTableRow key={elem._id}>
                  ...
                  <StyledTableCell align="left"><EllipsisText>{elem.branchCode}</EllipsisText></StyledTableCell>
