        ...
        <div>
            ...
            <List sx={{ marginTop: "30px" }}>
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin`} selected={location.pathname === `/admin`}>
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/patient-management`} selected={location.pathname === `/admin/patient-management`}>
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/appointment`} selected={location.pathname === `/admin/appointment`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/radiology`} selected={location.pathname === `/admin/radiology`}>
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/procedure-tracking`} selected={location.pathname === `/admin/procedure-tracking`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/image-report`} selected={location.pathname === `/admin/image-report`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton component={NavLink} to={`/admin/billing-invoice`} selected={location.pathname === `/admin/billing-invoice`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                ...
                {userData?.role === USER_ROLE_DEFAULT.ADMIN ? (<ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/referred-list`} selected={location.pathname === `/admin/referred-list`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none">
                                <path d="M20 18.2227H0V0.222717H2V16.2227H4V14.2227H8V16.2227H10V13.2227H14V16.2227H16V14.2227H20V18.2227ZM16 11.2227H20V13.2227H16V11.2227ZM10 3.22272H14V6.22272H10V3.22272ZM14 12.2227H10V7.22272H14V12.2227ZM4 7.22272H8V9.22272H4V7.22272ZM8 13.2227H4V10.2227H8V13.2227Z" fill="white" />
                            </svg>
                        </ListItemIcon>
                        <ListItemText className="ItemText" sx={{ margin: 0, }} primary={<Typography variant="sidebarlistitem">Referrals</Typography>} />
                    </CustomListButton>
                </ListItem>):<></>}
                {userData?.role === USER_ROLE_DEFAULT.ADMIN ? (<ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink}  to={`/admin/users`} selected={location.pathname === `/admin/users`}>
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                        ...
                        <ListItemText className="ItemText" sx={{ margin: 0, }} primary={<Typography variant="sidebarlistitem">User Management</Typography>} />
                    </CustomListButton>
                </ListItem>):<></>}
                
                {userData?.role === USER_ROLE_DEFAULT.ADMIN ? (<ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/admin/settings`} selected={location.pathname.includes("/admin/settings")} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                <path d="M9 0.222717C10.1935 0.222717 11.3381 0.696823 12.182 1.54074C13.0259 2.38465 13.5 3.52924 13.5 4.72272C13.5 5.91619 13.0259 7.06078 12.182 7.9047C11.3381 8.74861 10.1935 9.22272 9 9.22272C7.80653 9.22272 6.66193 8.74861 5.81802 7.9047C4.97411 7.06078 4.5 5.91619 4.5 4.72272C4.5 3.52924 4.97411 2.38465 5.81802 1.54074C6.66193 0.696823 7.80653 0.222717 9 0.222717ZM9 11.4727C13.9725 11.4727 18 13.4865 18 15.9727V18.2227H0V15.9727C0 13.4865 4.0275 11.4727 9 11.4727Z" fill="white" />
                            </svg>
