...
import { currentBranch as currentBranchSlice, getRequest } from "../../../redux/modules/branch/slice";
...
const settingsList = [
  {
    ...
    navLink: "Patient/edit-profile",
  },
  {
    navIcon: <InboxIcon />,
    navText: "Settings",
    navLink: "Patient/settings",
  }
];
...
const Header = ({ drawerWidth, handleDrawerToggle }) => {
  ...
  const filteredSettingList = userData.role !== USER_ROLE_DEFAULT.PATIENT
  ? settingsList
