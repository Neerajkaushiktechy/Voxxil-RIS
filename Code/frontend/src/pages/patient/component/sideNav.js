        ...
        <div>
            ...
            <List sx={{ marginTop: "30px" }}>
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient`} selected={location.pathname === `/Patient`}>
                ...
                {/* <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient/appointment`} selected={location.pathname === `/juniorRadiologist/appointment`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient/radiology`} selected={location.pathname === `/Patient/radiology`}>
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                ...
                {/* <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient/procedure-tracking`} selected={location.pathname === `/juniorRadiologist/procedure-tracking`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient/image-report`} selected={location.pathname === `/Patient/image-report`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton component={NavLink} to={`/Patient/billing-invoice`} selected={location.pathname === `/Patient/billing-invoice`}>
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                ...
                {/* <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                ...
                {/* <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/staff/settings`} selected={location.pathname.includes("/staff/settings")} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
