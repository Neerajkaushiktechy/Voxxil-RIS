        ...
        <div>
            ...
            <List sx={{ marginTop: "30px" }}>
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient`} selected={location.pathname === `/juniorRadiologist`}>
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient/radiology`} selected={location.pathname === `/juniorRadiologist/radiology`}>
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                ...
                <ListItem disablePadding sx={{ marginBottom: "20px" }}>
                    <CustomListButton onClick={() => { dispatch(setShowList(true)) }} component={NavLink} to={`/Patient/image-report`} selected={location.pathname === `/juniorRadiologist/image-report`} >
                        <ListItemIcon sx={{ width: "20px", height: "20px", marginRight: "20px", minWidth: "unset" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
